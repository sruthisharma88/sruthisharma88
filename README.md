...
Write SQL that usually works on the first try

Build forecasting models (ARIMA + ML) that attempt to predict the future better than guesswork

Work with satellite + geospatial data, because sometimes the answer is literally visible from space
...
AI pipelines combining NASA + ISRO datasets
...
Spanish (Learning… DELE B2 loading 🇪🇸)
